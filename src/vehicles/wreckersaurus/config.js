...
export const WRECKERSAURUS_TAIL_MAX_TORQUE = 20000;
export const WRECKERSAURUS_TAIL_RAISE_RATE = 2.4;
export const WRECKERSAURUS_TAIL_RELEASE_DURATION = 0.5;
export const WRECKERSAURUS_TAIL_RECOVER_RATE = 1.9;
export const WRECKERSAURUS_TAIL_DOWNSWING_DURATION = 0.5;
...
export const WRECKERSAURUS_TAIL_PACKED_MELT_ANGULAR_SLOWDOWN = 0.18;
export const WRECKERSAURUS_TAIL_PACKED_MELT_CONTACT_RADIUS_SCALE = 0.85;
